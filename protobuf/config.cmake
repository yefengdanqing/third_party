...
#
set(PROTOBUF_CONFIGURE    cd ${PROTOBUF_ROOT}/src/PROTOBUF && cmake -D CMAKE_INSTALL_PREFIX=${PROTOBUF_ROOT} -DCMAKE_INSTALL_LIBDIR=lib .)  # 指定配置指令（注意此处修改了安装目录，否则默认情况下回安装到系统目录）
set(PROTOBUF_MAKE         cd ${PROTOBUF_ROOT}/src/PROTOBUF && make -j8)  # 指定编译指令（需要覆盖默认指令，进入我们指定的PROTOBUF_ROOT目录下）
